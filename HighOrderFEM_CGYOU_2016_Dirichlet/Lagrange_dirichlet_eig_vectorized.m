...
[A_grad, A_L2, A_xx, A_xy, A_yy, bd_dof_idx, ndof] = Lagrange_dirichlet_eig_matrix_vectorized(Lagrange_order, vert, edge, tri, tri2edge, is_edge_bd);
...
function [A_glob_grad, A_glob_L2, A_glob_ux_ux, A_glob_ux_uy, A_glob_uy_uy, bd_dof_idx, ndof] = Lagrange_dirichlet_eig_matrix_vectorized(Lagrange_order, vert, edge, tri, tri2edge, is_edge_bd)
