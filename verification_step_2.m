function verification_step_2(input_file,output_file)
    ...
    for k = index_start:num_cells
        ...
        str_data = [
            ...
            compose("%.17g", cell_result.x_inf), ...
            compose("%.17g", cell_result.x_sup), ...
            compose("%.17g", cell_result.theta_inf), ...
            compose("%.17g", cell_result.theta_sup), ...
            compose("%.17g", cell_result.lam2_sup), ...
            compose("%.17g", cell_result.lam3_inf), ...
            string(isOK) ...
        ];        
        % str_data = [ ...
        %     string(cell_result.i), ...
